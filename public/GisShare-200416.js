...
function addressdataCallback(address) {
  ...
  //         str+="<tr><td>"+ address[i].OBJECTID+" </td>" +
  //             "<td>"+ address[i].使用状态+" </td>" +
  //             "<td>"+ address[i].区代码+" </td>" +
  //             "<td>"+ address[i].单元网格+" </td>" +
  //             "<td>"+ address[i].名称+" </td>" +
  //             "<td>"+ address[i].归属部门+" </td>" +
  //             "<td>"+ address[i].标识码+" </td>" +
  //             "<td>"+ address[i].街道代码+" </td>" +
  //             "</tr>";
  //
  //     }
  //     str+="</table>"
